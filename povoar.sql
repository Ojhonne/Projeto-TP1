...
-- Domínio Codigo: LLDDD
INSERT INTO PlanoDeSprint (codigo, texto, tempo, projeto_codigo) VALUES 
...
INSERT INTO HistoriaDeUsuario (codigo, titulo, papel, acao, valor, estimativa, prioridade, estado, projeto_codigo, sprint_codigo, pessoa_email) VALUES 
...
('HU012', 'Gerar Recibo', 'Cliente', 'Baixar PDF', 'Comprovante', '6', 'MEDIA', 'A FAZER', NULL, 'SP006', NULL); 


-- ==========================================
-- PROJETO 4: Portal Interno (Projeto Novo, sem Sprints)
-- ==========================================
-- 4. INSERINDO HISTÓRIAS DE USUÁRIO (Corrigido para evitar Primary Key duplicada)
INSERT INTO HistoriaDeUsuario (codigo, titulo, papel, acao, valor, estimativa, prioridade, estado, projeto_codigo, sprint_codigo, pessoa_email) VALUES 
